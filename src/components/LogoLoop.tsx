...
function useResizeObserver(callback: () => void, elements: RefObject<HTMLElement | null>[], dependencies: unknown[]) {
  useEffect(() => {
...
function useImageLoader(seqRef: RefObject<HTMLUListElement | null>, onLoad: () => void, dependencies: unknown[]) {
  useEffect(() => {
